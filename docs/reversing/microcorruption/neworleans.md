...
<img src="/assets/images/microcorruption/neworleans/one.png"
     alt="Microcorruption challenge progress"
     width="900"
...
<img src="/assets/images/microcorruption/neworleans/two.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
Beginning at main `0x4438`, I can identify a few interesting functions: **check_password** and **create_password**. 

Following the assembly in main the program gets the input from the user and makes a call (`0x4450`) to the **check_password** function located at `0x44BC`. Before investigating the internal operations of that function let's take a moment to understand the logic of the program. 

<img src="/assets/images/microcorruption/neworleans/three.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
<img src="/assets/images/microcorruption/neworleans/five.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">

### Analyzing check_password

Once reaching the breakpoint I stepped into the **check_password** function and identified the interesting cmp.b instruction. 

<img src="/assets/images/microcorruption/neworleans/six.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
<img src="/assets/images/microcorruption/neworleans/seven.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
<img src="/assets/images/microcorruption/neworleans/eight.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
<img src="/assets/images/microcorruption/neworleans/nine.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
<img src="/assets/images/microcorruption/neworleans/ten.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
...
This level shows the importance of refraining from hardcoding credentials into your program. The program attempts to avoid storing the complete password directly in memory at initialization. You may have noticed that if you attempted to inspect the memory at `0x2400` before the **create_password** function had been run you wouldn't find the password in memory. 

But by debugging the program and setting a breakpoint after that function sets the password, we can inspect the memory and find the password. Multiple runs of the program reveal the password is the same each time. This is clear when statically analyzing the **create_password** function which contains each byte of the password and writes them one by one to the location in memory. 

<img src="/assets/images/microcorruption/neworleans/eleven.png"
     alt="Microcorruption challenge progress"
     width="900"
     style="max-width: 100%; height: auto;">
